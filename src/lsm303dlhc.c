...
static lsm303dlhc_t lsm = {I2C1,           // i2c
...
static void lsm303dlhc_i2c_init()
{
    ...
    lsm.i2c->CR1     = 0;
    lsm.i2c->TIMINGR = (0 << I2C_TIMINGR_PRESC_Pos) |  // i2c frequency is 8MHz
...
static void lsm303dlhc_write_sub(uint8_t slave, uint8_t sub)
{
    ...
    lsm.i2c->CR2 &= ~(I2C_CR2_RD_WRN |  // write
...
static void lsm303dlhc_regs_read_sync(uint8_t slave,
                                      uint8_t begin_reg,
                                      uint8_t* data,
                                      uint8_t size)
{
    ...
    lsm.i2c->CR2 |= I2C_CR2_RD_WRN |  // read
...
static void lsm303dlhc_regs_read_async(uint8_t slave,
                                       uint8_t begin_reg,
                                       uint8_t* data,
                                       uint8_t size)
{
...
static void lsm303dlhc_reg_write_sync(uint8_t slave, uint8_t reg, uint8_t value)
{
    ...
    lsm.i2c->CR2 |= I2C_CR2_AUTOEND |           // auto stop
...
void lsm303dlhc_acc_regs_read_sync(lsm303dlhc_acc_reg_t reg,
                                   uint8_t* data,
                                   uint8_t size)
{
...
void lsm303dlhc_mag_regs_read_sync(lsm303dlhc_mag_reg_t reg,
                                   uint8_t* data,
                                   uint8_t size)
{
...
void lsm303dlhc_acc_regs_read_async(lsm303dlhc_acc_reg_t reg,
                                    uint8_t* data,
                                    uint8_t size)
{
    return lsm303dlhc_regs_read_async(LSM303DLHC_ACCELEROMETER, reg, data,
                                      size);
}

void lsm303dlhc_mag_regs_read_async(lsm303dlhc_mag_reg_t reg,
                                    uint8_t* data,
                                    uint8_t size)
{
